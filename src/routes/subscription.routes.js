 ...
 */
router.post("/", subscriptionLimiter, sanitize, validationRules.subscription.subscribe, validate, subscribe);
 ...
 */
router.post("/verify-otp", subscriptionLimiter, sanitize, validationRules.subscription.verifyOtp, validate, verifyOtp);
